...
public class PurchasingOrder_EntryController implements Initializable,ScreenInterface {
    ...
    public void inittable() {
        ...
        tblindex05.setStyle("-fx-alignment: CENTER-LEFT;-fx-padding: 0 0 0 5;");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        data.add(new ModelPurchaseOrder("1", "Samsung - Robinsons San Fernando LUN", "2025-02-11", "M00125000000", "1000"
        ));
        inittable();
