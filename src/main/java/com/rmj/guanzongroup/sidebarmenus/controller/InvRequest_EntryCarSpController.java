...
public class InvRequest_EntryCarSpController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TextField tfTransactionNo, tfBrand, tfModel, tfInvType, tfDescription, tfBarCode,
    ...
    @FXML
    private TableColumn<ModelInvOrderDetail, String> tblBrandDetail, tblBarCodeDetail, tblModelDetail, tblVariantDetail, tblColorDetail, tblInvTypeDetail, tblROQDetail, tblClassificationDetail, tblQOHDetail, tblReservationQtyDetail, tblOrderQuantityDetail;
        ...
        try {
            if (pnTblInvDetailRow >= 0) {
                ...
                if (invRequestController.StockRequest().Detail(pnTblInvDetailRow).Inventory().getDescription() != null) {
                    lsDesc = invRequestController.StockRequest().Detail(pnTblInvDetailRow).Inventory().getDescription();
                }
                tfDescription.setText(lsDesc);
