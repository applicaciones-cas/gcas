...
import static com.rmj.guanzongroup.sidebarmenus.controller.DeliveryAcceptance_ConfirmationMonarchHospitalityController.poPurchaseReceivingController;
...
public class DeliveryAcceptance_ConfirmationMonarchHospitalityController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchasing Order Receiving Confirmation Monarch Hospitality";
