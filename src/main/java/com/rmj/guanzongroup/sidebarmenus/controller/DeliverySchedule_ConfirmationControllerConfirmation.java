 ...
 * @author 12mnv
 */
public class DeliverySchedule_ConfirmationControllerConfirmation implements Initializable, ScreenInterface {
    ...
    @FXML
    private Button btnConfirm, btnVoid, btnUpdate, btnSearch, btnSave,
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(DeliverySchedule_ConfirmationControllerConfirmation.class.getName()).log(Level.SEVERE, null, ex);
            ...
            protected void succeeded() {
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_ConfirmationControllerConfirmation.class
