...
public class CheckTransfer_EntryController implements Initializable, ScreenInterface {
    ...
    private ObservableList<Model_Check_Payments> laTransactionList;
    private ObservableList<Model_Check_Transfer_Master> laTransactionMaster;
    ...
    @FXML
    private Button btnSearch, btnBrowse, btnNew, btnUpdate, btnSave, btnVoid,
            btnPrint, btnRetrieve, btnClose;
