                        ...
                        poJSON = poController.PurchaseOrderReceiving().printRecord(() -> {
                            ...
                            Platform.runLater(() -> {
                                try {
                                    ...
                                    Logger.getLogger(POReplacement_ConfirmationController.class.getName()).log(Level.SEVERE, null, ex);
...
//                        initAttachmentsGrid();
            ...
            Logger.getLogger(POReplacement_ConfirmationController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
                ...
                switch (lsID) {
                    case "dpTransactionDate":
                        ...
                        if (selectedDate.isAfter(currentDate)) {
                            ...
                            poController.PurchaseOrderReceiving().Master().setTransactionDate((SQLUtil.toDate(formattedDate, "yyyy-MM-dd")));
                        }
                        break;
                    case "dpReferenceDate":
                        if (selectedDate == null) {
...
//            tfCost.setText(CustomCommonUtil.setIntegerValueToDecimalFormat(poController.PurchaseOrderReceiving().Detail(pnDetail).getUnitPrce()));
    ...
    public void initTextFields() {
        ...
        JFXUtil.setFocusListener(txtMaster_Focus, tfTransactionNo,
                tfSupplier, tfSupplier, tfTrucking, tfTrucking,
                tfReferenceNo, tfReferenceNo, tfTerm, tfTerm,
                tfDiscountRate, tfDiscountRate, tfDiscountAmount,
                tfDiscountAmount, tfTotal);
        JFXUtil.setFocusListener(txtDetail_Focus, tfOrderNo,
                tfBarcode, tfDescription, tfSupersede,
                tfCost, tfReceiveQuantity, tfBrand, tfColor,
                tfMeasure, tfInventoryType, tfOrderQuantity, tfModel);
