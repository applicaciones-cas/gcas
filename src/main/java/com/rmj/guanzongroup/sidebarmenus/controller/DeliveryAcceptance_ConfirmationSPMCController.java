...
import static com.rmj.guanzongroup.sidebarmenus.controller.DeliveryAcceptance_ConfirmationSPMCController.poPurchaseReceivingController;
...
public class DeliveryAcceptance_ConfirmationSPMCController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchasing Order Receiving Confirmation SP MC";
