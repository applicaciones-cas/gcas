 ...
 * @author User
 */
public class InvRequest_UpdateCarController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Update Car";
    ...
    private void initFields(int fnEditMode) {
        ...
        if (fnEditMode == EditMode.UNKNOWN) {
            CustomCommonUtil.setDisable(true,
                    tfBrand, tfModel, tfOrderQuantity, tfInvType,
