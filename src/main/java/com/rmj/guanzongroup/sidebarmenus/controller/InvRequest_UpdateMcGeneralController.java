 ...
 * @author User
 */
public class InvRequest_UpdateMcGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Update Mc General";
     @FXML
