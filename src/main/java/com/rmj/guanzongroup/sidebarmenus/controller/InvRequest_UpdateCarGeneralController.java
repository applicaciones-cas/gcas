 ...
 * @author User
 */
public class InvRequest_UpdateCarGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Update Car General";
    @FXML
