...
import static com.rmj.guanzongroup.sidebarmenus.controller.DeliveryAcceptance_ConfirmationLPController.poPurchaseReceivingController;
...
public class DeliveryAcceptance_ConfirmationLPController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchasing Order Receiving Confirmation LP";
