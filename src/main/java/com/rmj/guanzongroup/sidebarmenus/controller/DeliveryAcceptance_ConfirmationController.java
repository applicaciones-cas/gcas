...
//        apBrowse.setDisable(lbShow); // no usage
        apMaster.setDisable(fnValue == EditMode.UNKNOWN);
        apDetail.setDisable(fnValue == EditMode.UNKNOWN);
    }
    ...
    public void retrievePO() {
        ...
        if ("success".equals((String) poJSON.get("result"))) {
            poJSON = poPurchaseReceivingController.getApprovedPurchaseOrderReceiving();
            if (!"success".equals((String) poJSON.get("result"))) {
                ShowMessageFX.Warning(null, pxeModuleName, (String) poJSON.get("message"));
            } else {
                loadTableMain();
...
//        tfSearchIndustry.focusedProperty().addListener(txtField_Focus);
