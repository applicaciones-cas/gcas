 ...
 * @author User
 */
public class InvRequest_Roq_UpdateAppliancesGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Update Appliances General";
    @FXML
