...
import static com.rmj.guanzongroup.sidebarmenus.controller.DeliveryAcceptance_ApprovalMonarchHospitalityController.poPurchaseReceivingController;
 ...
 * @author User
 */
public class DeliveryAcceptance_ApprovalMonarchHospitalityController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchasing Order Receiving Approval Monarch Hospitality";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            Logger.getLogger(DeliveryAcceptance_ApprovalMonarchHospitalityController.class.getName()).log(Level.SEVERE, null, ex);
...
//                Thread.sleep(1000);
            ...
            protected void succeeded() {
                ...
                if (main_data == null || main_data.isEmpty()) {
                    tblViewPuchaseOrder.setPlaceholder(new Label("NO RECORD TO LOAD") {
                        {
