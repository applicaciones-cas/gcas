    ...
    public class InvStockRequest_EntryCarController implements Initializable, ScreenInterface{
        ...
        @FXML
        private TextField tfTransactionNo,tfBrand,tfModel,tfCode,
                tfVariant,tfColor,tfCustomerOrder,tfOnHand,tfOrderQuantity,tfReferenceNo;
        @FXML
        ...
        @FXML
        private TableColumn<ModelInvOrderDetail, String> tblBrandDetail, tblModelDetail,tblOnHandDetail,tblCodeDetail,tblVariantDetail,tblColorDetail,tblCustOrderDetail,tblOrderQuantity;
...
//                    System.out.println("INDUSTRY"+invRequestController.StockRequest().Master().getIndustryId());
//                    invRequestController.StockRequest().Master().setCompanyID(psCompanyID);
//                    System.out.println("COMPANY"+invRequestController.StockRequest().Master().getCompanyID());
//                    //loadRecordSearch();
//                }));
//
...
//                initFields(EditMode.UNKNOWN);
                ...
                Logger.getLogger(InvStockRequest_EntryCarController.class.getName()).log(Level.SEVERE, null, ex);
...
//
//                    String lsModelCode = "";
//                    if (invRequestController.StockRequest().Detail(pnTblInvDetailRow).Inventory().Model().getModelCode()!= null) {
//                        lsModelCode = invRequestController.StockRequest().Detail(pnTblInvDetailRow).Inventory().Model().getModelCode();
//                    }
//                    tfCode.setText(lsModelCode);
//
//                    String lsVariant = "";
...
//
//                    String lsCustomerOrder = "0";
//                    if (invRequestController.StockRequest().Detail(pnTblInvDetailRow).getQuantity() != 0) {
//                        lsCustomerOrder = String.valueOf(invRequestController.StockRequest().Detail(pnTblInvDetailRow).getReservedOrder());
//                    }
//
//                    tfCustomerOrder.setText(lsCustomerOrder);
//
//                    String lsOnHand = "0";
//                    if (invRequestController.StockRequest().Detail(pnTblInvDetailRow).getQuantity() != 0) {
//                        lsOnHand = String.valueOf(invRequestController.StockRequest().Detail(pnTblInvDetailRow).getQuantityOnHand());
//                    }
//                    tfOnHand.setText(lsOnHand);
//
...
//                    tfColor, tfCustomerOrder, tfOnHand,tfCode, tfVariant);
...
//                                detail.Inventory().Model().getModelCode(),
...
//                    tfCode,tfVariant,tfColor,tfCustomerOrder,
//                    tfOnHand);
...
//            tblCustOrderDetail.setCellValueFactory(new PropertyValueFactory<>("index07"));
//            tblOrderQuantity.setCellValueFactory(new PropertyValueFactory<>("index08"));
