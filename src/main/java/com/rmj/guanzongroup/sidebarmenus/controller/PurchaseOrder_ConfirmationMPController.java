...
public class PurchaseOrder_ConfirmationMPController implements Initializable, ScreenInterface {
        ...
        try {
            ...
            switch (lsButton) {
                case "btnUpdate":
                    ...
                    break;
                case "btnConfirm":
                    loJSON = poPurchasingController.PurchaseOrder().ConfirmTransaction("Confirmed");
    ...
    private void clearDetailFields() {
        /* Detail Fields*/
        CustomCommonUtil.setText("", tfBrand, tfModel, tfBrand, tfBarcode, tfDescription, tfVariant,
