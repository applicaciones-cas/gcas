 ...
 * @author User
 */
public class InvRequest_UpdateLPGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Update LP General";
     @FXML
