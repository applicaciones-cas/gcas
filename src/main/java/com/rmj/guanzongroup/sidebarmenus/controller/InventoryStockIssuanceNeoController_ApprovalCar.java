...
public class InventoryStockIssuanceNeoController_ApprovalCar implements Initializable, ScreenInterface {
    ...
    void ontblDetailClicked(MouseEvent e) {
        try {
            ...
            Logger.getLogger(InventoryStockIssuanceNeoController_ApprovalCar.class.getName()).log(Level.SEVERE, null, ex);
            poLogWrapper.severe(psFormName + " :" + ex.getMessage());
        }
    }
    ...
    private void loadTransactionMasterList(String value, String fsColumn) {
        ...
        Task<ObservableList<Model_Inventory_Transfer_Master>> loadTransaction = new Task<ObservableList<Model_Inventory_Transfer_Master>>() {
            ...
            protected void failed() {
                ...
                Logger
                        .getLogger(InventoryStockIssuanceNeoController_ApprovalCar.class
                                .getName()).log(Level.SEVERE, null, ex);
                poLogWrapper.severe(psFormName + " : " + ex.getMessage());
            }
        ...
        if (laTransactionDetail == null) {
            ...
            tblColDetailSerial.setCellValueFactory(loModel -> {
                try {
                    ...
                    Logger.getLogger(InventoryStockIssuanceNeoController_ApprovalCar.class
                            .getName()).log(Level.SEVERE, null, ex);
                    poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                    return new SimpleStringProperty("");
                }
