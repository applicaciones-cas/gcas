 ...
 * @author User
 */
public class InvRequest_Roq_UpdateLPFoodController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Update LP Food";
    ...
    @FXML
    private TextField tfTransactionNo, tfBrand, tfInvType, tfMeasure, tfROQ, tfClassification, tfQOH, tfReferenceNo, tfReservationQTY,
    ...
    @FXML
        private Button btnNew,btnClose,btnSave,btnCancel,btnBrowse,btnUpdate,btnRetrieve;
    @FXML
    private TableView<ModelInvOrderDetail> tblViewOrderDetails;

    @FXML
        private TableColumn<ModelInvOrderDetail, String> tblBrandDetail,tblInvTypeDetail,
            tblROQDetail,tblClassificationDetail,tblQOHDetail,
            tblReservationQtyDetail,tblOrderQuantityDetail,tblDescriptionDetail,tblBarCodeDetail, tblMeasureDetail;
    @FXML
    ...
    private TableColumn<ModelInvOrderDetail, String> tblBrandDetail,
            ...
            tblOrderQuantityDetail, tblDescriptionDetail, tblBarCodeDetail;
        ...
        Task<Void> task = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                try {
                    ...
                    Logger.getLogger(InvRequest_ConfirmationMcSpController.class
    ...
    private void initFields(int fnEditMode) {
     ...
     private void initButtonsClickActions() {
            List<Button> buttons = Arrays.asList( btnNew, btnSave, btnCancel,
                    btnClose,btnRetrieve,btnUpdate,btnBrowse);
    ...
    private void initTableInvDetail() {
        ...
        tblDescriptionDetail.setCellValueFactory(new PropertyValueFactory<>("index01"));
        ...
        tblROQDetail.setCellValueFactory(new PropertyValueFactory<>("index05"));
        tblClassificationDetail.setCellValueFactory(new PropertyValueFactory<>("index06"));
        tblQOHDetail.setCellValueFactory(new PropertyValueFactory<>("index7"));
        tblReservationQtyDetail.setCellValueFactory(new PropertyValueFactory<>("index8"));
        tblOrderQuantityDetail.setCellValueFactory(new PropertyValueFactory<>("index9"));
