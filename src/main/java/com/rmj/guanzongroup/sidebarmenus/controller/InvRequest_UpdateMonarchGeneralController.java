 ...
 * @author User
 */
public class InvRequest_UpdateMonarchGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Update Monarch General";
     @FXML
