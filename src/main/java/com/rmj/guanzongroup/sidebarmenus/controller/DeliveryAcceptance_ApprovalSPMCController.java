...
import static com.rmj.guanzongroup.sidebarmenus.controller.DeliveryAcceptance_ApprovalSPMCController.poPurchaseReceivingController;
 ...
 * @author User
 */
public class DeliveryAcceptance_ApprovalSPMCController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchasing Order Receiving Approval SP MC";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            Logger.getLogger(DeliveryAcceptance_ApprovalSPMCController.class.getName()).log(Level.SEVERE, null, ex);
